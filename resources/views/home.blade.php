                    ...
                    <div class="flex items-center w-full px-4 -mx-3 sm:-mx-4 lg:w-6/12">
                        <div class="w-full px-3 xl:w-1/2 sm:px-4">
                            <div class="py-3 sm:py-4">
                                <img src="https://d3v5ezchayoty7.cloudfront.net/wp-content/uploads/shutterstock_538414771-1.jpg"
                                    alt="" class="w-full rounded-2xl" />
                            </div>
                            <div class="py-3 sm:py-4">
                                <img src="https://www.niveshmarket.com/wp-content/uploads/2019/11/Personal-finance.jpg"
                                    alt="" class="w-full rounded-2xl" />
                            </div>
                        </div>
                        ...
                        <div class="w-full px-3 xl:w-1/2 sm:px-4">
                            <div class="relative z-10 my-4">
                                <img src="http://sunnyleand.com/wp-content/uploads/2018/01/manage-personal-finances-right.jpg"
                                    alt="" class="w-full rounded-2xl" />
